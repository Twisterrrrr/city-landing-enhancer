...
interface RiverFilterBarProps {
  cities: string[];
  filters: RiverFilterState;
  onChange: (f: RiverFilterState) => void;
}
...
function AmenityIcons({ filters, toggleAmenity }: { filters: RiverFilterState; toggleAmenity: (a: Amenity) => void }) {
  return (
    <>
      {ALL_AMENITIES.map((a) => {
...
function ResetButton({ filters, onChange }: { filters: RiverFilterState; onChange: (f: RiverFilterState) => void }) {
...
export function RiverFilterBar({ cities, filters, onChange }: RiverFilterBarProps) {
